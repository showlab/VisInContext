...
def render_text_with_pil(text, font_path="src/data/base/open-sans/OpenSans-Regular.ttf", font_size=16, image_size=(224*14, 16), text_color="black", background_color="white", margin=10):
    ...
    # Use a fixed margin from the left for the X position
    text_position = (margin, text_position_y)
    draw.multiline_text(text_position, text, fill=text_color, font=font, spacing=4)
    return image


def render_text_with_pil_multiple(text, font_path="src/data/base/open-sans/OpenSans-Regular.ttf", font_size=16, image_size=(224*14, 16), text_color="black", background_color="white", margin=10, n_parts=3):
    """
    ...
    font = ImageFont.truetype(font_path, font_size)
    # Ensure text is evenly split into N parts
    ...
    for part in parts:
        ...
        # Vertically center the text in the image
