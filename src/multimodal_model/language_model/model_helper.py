...
def extend_instance(obj, mixin):
    ...
    # below is for mixtral 7x8b network
    if hasattr(mixin, 'forward'):
        # Directly set the forward method from the mixin on the instance.
        # This requires the mixin's forward method to be defined in a way that it can operate on the instance.
        obj.forward = mixin.forward.__get__(obj, obj.__class__)
